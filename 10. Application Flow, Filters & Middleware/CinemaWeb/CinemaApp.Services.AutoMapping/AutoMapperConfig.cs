...
public class AutoMapperConfig
{
    ...
    public static IMapper MapperInstance { get; private set; } = null!;
    ...
    {
        IEnumerable<IHaveCustomMappings> customMaps = 
            from t in types
            from i in t.GetTypeInfo().GetInterfaces()
            where typeof(IHaveCustomMappings).GetTypeInfo().IsAssignableFrom(i.GetTypeInfo()) &&
                  !t.GetTypeInfo().IsAbstract &&
                  !t.GetTypeInfo().IsInterface
