...
{ 
    ...
    public async Task<IActionResult> Index()
    {
        ...
        IEnumerable<MovieAllDto> movieAllDtos = await movieService.GetAllMoviesOrderedAsync(userId);
    ...
    public async Task<IActionResult> Create(MovieFormModel movieFormModel)
    {
        ...
        catch (Exception ex)
        {
            ...
            TempData[ErrorTempDateKey] = UnexpectedErrorMessage;
            return View(movieFormModel);
        }
        
        TempData[SuccessTempDataKey] = $"Added new movie {movieFormModel.Title} successfully";
    ...
    public async Task<IActionResult> Edit([FromRoute] Guid id, MovieFormModel movieFormModel)
    {
        ...
        TempData[SuccessTempDataKey] = $"Edited the movie {movieFormModel.Title} successful";
    ...
    public async Task<IActionResult> Delete(Guid id, MovieDetailsViewModel? movieDetails)
    {
        ...
        TempData[SuccessTempDataKey] = "Deleted movie successfully";
        return RedirectToAction(nameof(Index));
    }
}