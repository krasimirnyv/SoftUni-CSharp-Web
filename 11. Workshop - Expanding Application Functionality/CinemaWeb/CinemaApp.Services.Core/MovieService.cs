...
public class MovieService(IMovieRepository movieRepository, IWatchlistRepository watchlistRepository, IMapper mapper) : IMovieService
{
    public async Task<IEnumerable<MovieAllDto>> GetAllMoviesOrderedAsync(string? userId = null)
    {
        // Fetch data
