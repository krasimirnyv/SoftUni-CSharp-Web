    ...
    private List<Movie> SeedMovies()
    {
        List<Movie> movies = new List<Movie>
        {
            ...
            new()
            {
                ...
                Title = "Inception",
                Genre = "Sci-Fi",
                ReleaseDate = DateOnly.FromDateTime(new DateTime(2010, 07, 16)),
                Director = "Christopher Nolan",
                Duration = 148,
                Description =
                    "A thief who enters the dreams of others to steal secrets is given the inverse task: planting an idea into someone's mind.",
                ImageUrl =
            ...
            new()
            {
                ...
                Genre = "Action",
                ReleaseDate = DateOnly.FromDateTime(new DateTime(2008, 07, 18)),
                Director = "Christopher Nolan",
                Duration = 152,
                Description =
                    "Batman faces the Joker, who seeks to create chaos in Gotham through psychological warfare.",
                ImageUrl =
            ...
            new()
            {
                ...
                Title = "Interstellar",
                Genre = "Sci-Fi",
                ReleaseDate = DateOnly.FromDateTime(new DateTime(2014, 11, 07)),
                Director = "Christopher Nolan",
                Duration = 169,
                Description =
                    "A group of explorers travel through a wormhole in space in search of a new habitable planet.",
                ImageUrl =
            ...
            new()
            {
                ...
                Duration = 162,
                Description =
                    "A paraplegic Marine is sent to the moon Pandora on a mission but becomes torn between following orders and protecting an alien civilization.",
                ImageUrl =
            ...
            new()
            {
                ...
                Title = "The Matrix",
                Genre = "Sci-Fi",
                ReleaseDate = DateOnly.FromDateTime(new DateTime(1999, 03, 31)),
            ...
            new()
            {
                ...
                Title = "Forrest Gump",
                Genre = "Drama",
                ReleaseDate = DateOnly.FromDateTime(new DateTime(1994, 07, 06)),
            ...
            new()
            {
                ...
                Title = "Gladiator",
                Genre = "Action",
                ReleaseDate = DateOnly.FromDateTime(new DateTime(2000, 05, 05)),
            ...
            new()
            {
                ...
                Genre = "Drama",
                ReleaseDate = DateOnly.FromDateTime(new DateTime(1994, 09, 23)),
            ...
            new()
            {
                ...
                Title = "Pulp Fiction",
                Genre = "Crime",
                ReleaseDate = DateOnly.FromDateTime(new DateTime(1994, 10, 14)),
                Director = "Quentin Tarantino",
                Duration = 154,
                Description =
                    "The lives of two hitmen, a boxer, and a gangster intertwine in four tales of violence and redemption.",
                ImageUrl =
                    "https://www.tallengestore.com/cdn/shop/products/PulpFiction-JohnTravoltaAndSamuelLJackson-MovieStill1_d3db6d19-235a-45aa-97b2-ab690665c224.jpg?v=1684129898"
            }
        };
